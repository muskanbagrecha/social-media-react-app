export const WhoToFollow = () => {
  ...
  return (
    <div className="w-1/5 dark:bg-gray-800 rounded-md  mx-2 hidden md:flex lg:flex">
      <div className="overflow-y-auto p-3 md:py-4 lg:py-4 bg-gray-50 dark:bg-gray-800 rounded  sticky top-20 w-full">
        ...
        <div>
          {data.map((user) => (
            <div className="flex px-2 w-full rounded  hover:cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
